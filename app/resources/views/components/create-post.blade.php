<!-- Load Alpine.js and your assets -->
    ...
    >
        ...
        >
            ...
            <div class="flex items-center justify-between px-6 pt-5 pb-2 border-b border-gray-800">
                ...
                <button 
                    @click="open = false"
                    class="text-gray-400 hover:text-white text-2xl font-semibold"
                >
                    ✕
                </button>
                ...
                <button 
                    type="button"
                    id="openDraftsBtn"
                    class="text-orange-400 hover:text-orange-500 text-sm font-medium transition"
                >
                    Drafts
                </button>
            </div>
                ...
                >
                    ...
                    <div class="flex items-center justify-between mt-4 border-t border-gray-800 pt-3">
                        <div class="flex items-center gap-3">
                            <label for="imageInput" class="cursor-pointer text-gray-400 hover:text-orange-400 transition-colors">
                        ...
                        <button 
                            type="submit"
                            class="bg-orange-500 text-white font-semibold rounded-full px-5 py-2 hover:bg-orange-600 focus:ring-2 focus:ring-orange-300 transition"
                        >
                            Squeal
                        </button>
                    </div>
...
@guest
<div class="p-6 border border-gray-800 rounded-2xl bg-gray-900 text-center text-gray-400">
    <p>Welcome to <span class="text-orange-400 font-medium">Squeal</span>!</p>
    <p>
        Please <a href="{{ route('login') }}" class="text-orange-400 hover:underline">login</a> or 
        <a href="{{ route('register.form') }}" class="text-orange-400 hover:underline">register</a> 
        to squeal with others.
    </p>
</div>
@endguest

<!-- Import CSS and JS -->
<link rel="stylesheet" href="{{ asset('assets/css/createpost.css') }}">
